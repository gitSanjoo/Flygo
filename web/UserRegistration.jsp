...
<br>
<
<h1 style="text-align: center"/>New User Registration
<br><br>

<div style="border:3px solid pink;width:25%;border-radius:20px;padding:20px;margin: auto;color:white;background-color:blueviolet">
